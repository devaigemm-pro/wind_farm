...
export const translations: TranslationMap = {
  ...
  'repair.editDefect': { en: 'Edit', es: 'Editar' },
  'repair.editType': { en: 'Type', es: 'Tipo' },
  'repair.editDefectNumber': { en: 'Defect number', es: 'Número de defecto' },
  'repair.editDefectIdentifier': { en: 'Defect identifier', es: 'Defect identifier' },
  'repair.editSave': { en: 'Save', es: 'Guardar' },
  'repair.editCancel': { en: 'Cancel', es: 'Cancelar' },
  'repair.editSuccess': { en: 'Defect updated', es: 'Defecto actualizado' },
  'repair.editError': { en: 'Could not update the defect', es: 'No se pudo actualizar el defecto' },
  'repair.deleteDefect': { en: 'Delete', es: 'Eliminar' },
  'repair.deleteDefectConfirm': { en: 'Delete this defect? This action cannot be undone.', es: '¿Eliminar este defecto? Esta acción no se puede deshacer.' },
  'repair.deleteDefectSuccess': { en: 'Defect deleted', es: 'Defecto eliminado' },
  'repair.deleteDefectError': { en: 'Could not delete the defect', es: 'No se pudo eliminar el defecto' },
  ...
  'quoteDetail.saveQuote': { en: 'Send quote', es: 'Enviar cotización' },
  'quoteDetail.saving': { en: 'Saving...', es: 'Guardando...' },
  'quoteDetail.technicians': { en: 'Technicians', es: 'N° técnicos' },
  ...
  'users.new': { en: 'New user', es: 'Nuevo usuario' },
  'users.name': { en: 'Name', es: 'Nombre' },
  'users.lastName': { en: 'Last name', es: 'Apellidos' },
  'users.rut': { en: 'RUT', es: 'RUT' },
  'users.email': { en: 'Email', es: 'Correo' },
  ...
  'users.edit': { en: 'Edit user', es: 'Editar usuario' },
  'users.delete': { en: 'Delete user', es: 'Eliminar usuario' },
  'users.create': { en: 'Create', es: 'Crear' },
  'users.save': { en: 'Save', es: 'Guardar' },
  'users.saving': { en: 'Saving…', es: 'Guardando…' },
  'users.cancel': { en: 'Cancel', es: 'Cancelar' },
  'users.confirmDelete': {
  ...
  'users.passwordHint': {
    en: 'Min. 8 chars, with uppercase, lowercase and a number',
    es: 'Mín. 8 caracteres, con mayúscula, minúscula y un número',
  },
  'users.nameRequired': { en: 'Name is required', es: 'El nombre es obligatorio' },
  'users.credentialsRequired': {
    en: 'Email and password are required',
    es: 'El correo y la contraseña son obligatorios',
  },
  'users.noFarms': { en: 'No wind farms available', es: 'No hay parques disponibles' },
  'users.empty': { en: 'No users yet', es: 'Aún no hay usuarios' },
  'users.emptyDesc': {
    en: 'Create the first user to get started.',
    es: 'Crea el primer usuario para comenzar.',
  },
  'users.created': { en: 'User created', es: 'Usuario creado' },
  'users.saved': { en: 'User updated', es: 'Usuario actualizado' },
