...
export type UserRole = 'inspector' | 'supervisor' | 'admin' | 'client' | 'technician' | 'analyst_ss' | 'analyst_sr';
...
export const USER_ROLES: readonly UserRole[] = ['inspector', 'supervisor', 'admin', 'client', 'technician', 'analyst_ss', 'analyst_sr'] as const;
