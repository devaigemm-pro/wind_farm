...
const planBtn: React.CSSProperties = { width: '100%', padding: '12px', background: '#00A6FF', color: '#fff', border: 'none', borderRadius: 8, fontSize: '0.9rem', fontWeight: 600, textAlign: 'center', cursor: 'pointer' };
