...
const planBtn: React.CSSProperties = { width: '100%', padding: '12px', background: '#4CAF50', color: 'var(--color-neutral-0)', border: 'none', borderRadius: 'var(--radius-md)', fontSize: 'var(--text-sm)', fontWeight: 500, textAlign: 'center', cursor: 'pointer', fontFamily: 'var(--font-family-sans)' };
