-- Seed blade serial numbers for all wind farms

-- Alto de la Degollada (ADD-T01 to ADD-T04)
...
-- Sierra del Madero (SDM-T01 to T05)
...
-- Peña del Cuervo (PDC-T01 to T08)
...
-- Los Llanos de Aridane (LLA-T01 to T03)
